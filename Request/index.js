...
var fs = require('fs'); // Package enables reading and writing files
var csv = require('csv');
var url = require('url');
var create_html = require('./createHTML.js');
var update_log = require('./updateLog.js');
